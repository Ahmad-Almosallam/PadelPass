...
public class SubscriptionService
{
    ...
    public async Task<ApiResponse<SubscriptionDto>> GetByIdAsync(
        int id)
    {
        try
        {
    ...
    public async Task<ApiResponse<SubscriptionDto>> CreateAsync(
        CreateSubscriptionDto dto)
    {
        try
        {
            ...
            var user = await _userManager.FindByIdAsync(userId);
            var isEndUser = await _userManager.IsInRoleAsync(user, AppRoles.User);
            if (!isEndUser)
            {
                return ApiResponse<SubscriptionDto>.Fail("User is not an customer");
            }
    ...
    public async Task<ApiResponse<SubscriptionDto>> UpdateAsync(
        int id,
    ...
    public async Task<ApiResponse<SubscriptionDto>> ExtendSubscriptionAsync(
        ExtendSubscriptionDto dto)
    {
        try
        {
            var subscription = await _repository.AsQueryable(true)
    ...
    public async Task<ApiResponse<SubscriptionDto>> PauseSubscriptionAsync(
        int id)
    {
        try
        {
    ...
    public async Task<ApiResponse<SubscriptionDto>> ResumeSubscriptionAsync(
        int id)
    {
        try
        {
